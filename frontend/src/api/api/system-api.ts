...
// @ts-ignore
import type { HandlersSystemInfoResponse } from '../models';
/**
...
export const SystemApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getSystemInfo: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/system/info`;
...
export const SystemApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getSystemInfo(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HandlersSystemInfoResponse>> {
...
export const SystemApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getSystemInfo(options?: RawAxiosRequestConfig): AxiosPromise<HandlersSystemInfoResponse> {
